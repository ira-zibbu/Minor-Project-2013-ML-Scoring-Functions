...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 29 10:12:21 2023
This file performs a grid search of optimal hyperparamters for SVR
@author: ira
"""
import numpy as np
import pandas as pd
...
def param_space(e1,e2,e3): #this function generates the hyperparameter space. e1, e2, e3 are the range of exponents
...
clf = GridSearchCV(regressor, svr_params, cv = 10, scoring='r2', verbose=2)
