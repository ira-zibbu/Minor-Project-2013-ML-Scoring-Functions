This folder contains all python scripts for the general test and the protein specific tests. For more information, refer to the report PDF or the individual scripts. These scripts need to be present in the same directory as processdata.py

Hyperparamters for these models were optimized on the primary training set.
