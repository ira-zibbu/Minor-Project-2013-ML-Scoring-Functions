#This module performs multivariate linear regression on the feature sets. It provides the pearson correlation
...
print("coefficients = " , model_r.coef_) #coefficients of the scoring functions
print('intercepts = ' , model_r.intercept_) #y intercept of the scoring function
...
plt.show()
residuals_test = np.subtract(y_predict, y_test)
plt.scatter(y_predict,residuals_test)
plt.xlabel('Predicted binding affinities')
plt.ylabel('Residuals')
plt.title('Residuals vs predicted binding affinities for linear regression')
plt.show
